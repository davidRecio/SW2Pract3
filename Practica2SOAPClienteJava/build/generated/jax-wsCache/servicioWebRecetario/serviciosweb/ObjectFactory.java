...
public class ObjectFactory {
    ...
    private final static QName _ImportarRecetaBytes_QNAME = new QName("", "bytes");
    private final static QName _ExportarRecetaResponseReturn_QNAME = new QName("", "return");
    ...
    public JAXBElement<byte[]> createImportarRecetaBytes(byte[] value) {
        return new JAXBElement<byte[]>(_ImportarRecetaBytes_QNAME, byte[].class, ImportarReceta.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createExportarRecetaResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ExportarRecetaResponseReturn_QNAME, byte[].class, ExportarRecetaResponse.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createValidarXSDBytes(byte[] value) {
        return new JAXBElement<byte[]>(_ImportarRecetaBytes_QNAME, byte[].class, ValidarXSD.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createImportarRecetarioBytes(byte[] value) {
        return new JAXBElement<byte[]>(_ImportarRecetaBytes_QNAME, byte[].class, ImportarRecetario.class, ((byte[]) value));
    }
    ...
    public JAXBElement<byte[]> createExportarRecetarioResponseReturn(byte[] value) {
        return new JAXBElement<byte[]>(_ExportarRecetaResponseReturn_QNAME, byte[].class, ExportarRecetarioResponse.class, ((byte[]) value));
    }
