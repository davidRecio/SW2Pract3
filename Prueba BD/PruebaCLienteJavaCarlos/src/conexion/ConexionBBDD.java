...
public class ConexionBBDD {
    ...
    public void init() {
        try {
            ...
            datasource = (DataSource) initialContext.lookup("jdbc/EjemploDatabase"); //CAMBIAR Al POOL QUE LE PONGAMOS
            ...
            createStatement.close();
            createStatement.execute("CREATE TABLE IF NOT EXISTS CONJUNTO_RECETARIO (NOMBRE_CONJUNTO VARCHAR(20), USUARIO_ID INT NOT NULL, RECETARIO_ID NOT NULL,FOREIGN KEY (USUARIO_ID) REFERENCES USUSARIO (USUARIO_ID), FOREIGN KEY (RECETARIO_ID) REFERECNCES RECETARIO (RECETARIO_ID), PRIMARY KEY (USUARIO_ID, RECETARIO_ID) )");
            createStatement.close();
